export const projects = [
  {
    ...
    features: ['User registration & login', 'Comment & Subscribe features', 'Admin blog management (CRUD)', 'Role-based permissions', 'Category-based blog listing', 'Responsive UI design','Search & Pagintation'],
  ...
  },
  {
    ...
    category: 'Personal',
    techStack: ['React', 'Supabase', 'shadcn/ui', 'Tailwind CSS', 'Tanstack Query','zustand', 'recharts'],
    features: ['Products management', 'Category management', 'Invoice & Printing','Table Management','User Management', 'Reports & Dashboard', 'Responsive Design'],
...

  {
    ...
    features: ['Authentication','Admin management', 'volunteer registration & listing', 'Event management', 'Course management', 'Contact form'],
